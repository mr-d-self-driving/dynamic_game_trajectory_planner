...
For further information and videos of **DeepGame-TP** implemented in [**ADORe**](https://github.com/DLR-TS/adore), please visit this [page](https://giovannilucente.github.io/dynamic_game_trajectory_planner/index.html).
